...
const RegistrarDevolucao: React.FC = () => {
  ...
  const [dataDevolucaoPrevista, setDataDevolucaoPrevista] =
    useState<string>("");
      ...
      if (dataDevolucaoDate > dataPrevista) {
        ...
        toast.promise(
          api.post("/emprestimo/devolucao", {
            ...
            dataDevolucao,
            valorMulta: valorMultaTotal > 0 ? valorMultaTotal : undefined,
          }),
          {
  ...
  const handleDataDevolucaoChange = (
